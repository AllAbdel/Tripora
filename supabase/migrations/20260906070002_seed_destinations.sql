...
values
  ...
  ('tenerife', 'Tenerife', 'Espagne', 'ES', 28.2916, -16.6291, '{TFS,TFN}', '{"culture":0.3,"nature":0.95,"food":0.65,"nightlife":0.7,"relax":0.95,"adventure":0.9,"shopping":0.4,"offbeat":0.5}'::jsonb, 0.8, 0.7, '{1,2,3,4,10,11,12}', 'Atlantic/Canary'),
  ('rome', 'Rome', 'Italie', 'IT', 41.9028, 12.4964, '{FCO,CIA}', '{"culture":1,"nature":0.3,"food":0.95,"nightlife":0.7,"relax":0.4,"adventure":0.3,"shopping":0.7,"offbeat":0.5}'::jsonb, 1, 1, '{4,5,9,10}', 'Europe/Rome'),
  ...
  ('milan', 'Milan', 'Italie', 'IT', 45.4642, 9.19, '{MXP,LIN,BGY}', '{"culture":0.75,"nature":0.3,"food":0.85,"nightlife":0.8,"relax":0.3,"adventure":0.2,"shopping":0.95,"offbeat":0.4}'::jsonb, 1.1, 0.8, '{4,5,6,9,10}', 'Europe/Rome'),
  ...
  ('stockholm', 'Stockholm', 'Suède', 'SE', 59.3293, 18.0686, '{ARN,NYO}', '{"culture":0.8,"nature":0.8,"food":0.85,"nightlife":0.75,"relax":0.6,"adventure":0.6,"shopping":0.7,"offbeat":0.6}'::jsonb, 1.35, 0.8, '{6,7,8}', 'Europe/Stockholm'),
  ...
  ('londres', 'Londres', 'Royaume-Uni', 'GB', 51.5074, -0.1278, '{LHR,LGW,STN,LTN}', '{"culture":1,"nature":0.3,"food":0.9,"nightlife":0.95,"relax":0.3,"adventure":0.3,"shopping":1,"offbeat":0.8}'::jsonb, 1.35, 1, '{5,6,7,8,9}', 'Europe/London'),
  ...
  ('paris', 'Paris', 'France', 'FR', 48.8566, 2.3522, '{CDG,ORY,BVA}', '{"culture":1,"nature":0.3,"food":0.95,"nightlife":0.8,"relax":0.4,"adventure":0.2,"shopping":0.95,"offbeat":0.6}'::jsonb, 1.25, 1, '{4,5,6,9,10}', 'Europe/Paris'),
